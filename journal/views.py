...
class PostList(generic.ListView):
    """
    List journal posts and paginate by 6
    """
    model = Post
...
class PostDetail(View):
    """
    Show individual journal page when a user clicks
    on a journal entry from the PostList
    """
...
def add_post(request):
    ...
    template = 'journal/add_post.html'
    context = {
        'form': form,
    }
...
def edit_post(request, slug):
    ...
    template = 'journal/edit_post.html'
    context = {
        'form': form,
        'post': post,
    }
...
def delete_post(request, slug):
    ...
    template = 'journal/delete_post.html'
    context = {
        'post': post,
    }
